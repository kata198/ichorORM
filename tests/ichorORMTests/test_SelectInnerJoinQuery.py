...
'''
    test_SelectInnerJoinQuery - Test the SelectInnerJoinQuery
'''
...
from ichorORM.query import InsertQuery, SelectQuery, SelectInnerJoinQuery, QueryStr
from ichorORM.objs import DictObj

from ichor_test_models.all import Person, Meal

class TestSelectInnerJoinQuery(object):
    '''
        Test class for a SelectInnerJoinQuery
    '''
    ...
    def test_generalGetMapping(self):
        '''
            test_generalGetMapping - Test general querying using SelectInnerJoinQuery
        '''
        ...
        selQWhere.addCondition(Person.TABLE_NAME + '.id', '=', QueryStr(Meal.TABLE_NAME + '.id_person'))
    ...
    def test_generalGetDictObjs(self):
        '''
            test_generalGetDictObjs - Test general querying using SelectInnerJoinQuery
        '''
    ...
    def test_tableStarSelectFields(self):
        ...
        '''
        mealStarQ = SelectInnerJoinQuery( [Meal, Person], selectFields=[ Person.TABLE_NAME + '.age', Meal.TABLE_NAME + '.*' ] )
        ...
        selQ = SelectInnerJoinQuery( [Person, Meal], selectFields=[ Person.TABLE_NAME + '.*', Meal.TABLE_NAME + '.*'] )
